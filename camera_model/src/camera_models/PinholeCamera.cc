...
{
/**
 * @brief Construct a new Pinhole Camera:: Parameters:: Parameters object
 * 
 */
PinholeCamera::Parameters::Parameters()
 : Camera::Parameters(PINHOLE)
 , m_k1(0.0)/// distortion parameter k1
 , m_k2(0.0)/// distortion parameter k2
 , m_p1(0.0)/// distortion parameter p1
 , m_p2(0.0)/// distortion parameter p2
 , m_fx(0.0)/// projection parameter fx
 , m_fy(0.0)/// projection parameter fy
 , m_cx(0.0)/// projection parameter cx
 , m_cy(0.0)/// projection parameter cy
{
...
PinholeCamera::Parameters::readFromYamlFile(const std::string& filename)
{
    ...
    //verify model type is "PINHOLE" or not
    if (!fs["model_type"].isNone())
    {
        std::string sModelType;
        fs["model_type"] >> sModelType;
        // check whether camera midel type is right
...
/**
 * @brief override operator "=" to make it work as normal "="
 * 
 * @param other: other parameters object
 * @return: other parameters object
 */
...
/**
 * @brief override operator "<<" to output Parameters with ostream
 * 
 * @param out:
 * @param params:
 * @return:
...
/**
 * @brief Construct a new Pinhole Camera:: Pinhole Camera object
 * 
 */
 ...
 * @param imageHeight: height of current image
 * @param k1: distortion parameter
 * @param k2: distortion parameter
 * @param p1: distortion parameter
 * @param p2: distortion parameter
 * @param fx: projection parameter
 * @param fy: projection parameter
 * @param cx: projection parameter
 * @param cy: projection parameter
 */
 ...
 * @brief Construct a new Pinhole Camera:: Pinhole Camera object
 * 
 * @param params: PinholeCamera::Parameters object
 */
