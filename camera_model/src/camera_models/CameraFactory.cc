...
/**
 * @brief Get point of cameraFactory
 * 
 * @return: shared_ptr of CameraFactory
 */
...
/**
 * @brief generate Camera object according to modelType
 * 
 * @param modelType: camera model
 * @param cameraName: camera name
 * @param imageSize: image Size
 * @return: shared_ptr of camera
 */
CameraPtr
...
/**
 * @brief generate camera object according to YAML file
 * 
